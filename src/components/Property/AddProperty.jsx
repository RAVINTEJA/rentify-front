...
const PostProperty = () => {
    ...
    const onChange = (e) => {
        ...
        if (e.target.name === "images") {
            ...
            ["area", "bedrooms", "bathrooms", "rentPrice"].includes(
                e.target.name
            )
        ) {
    ...
    return (
        <div className="container flex flex-col items-center justify-center">
            <h2 className="py-4 text-3xl font-bold self-start text-primary">
                Post Property
            </h2>
            <form
                className="w-full p-8 grid gap-4 md:grid-cols-2 bg-white rounded-lg shadow-lg"
                onSubmit={onSubmit}
            >
                <div className="mb-4">
                ...
                <div className="md:col-span-2 flex justify-center">
                    <button
                        type="submit"
                        className="w-full max-w-xs p-3 text-white transition duration-300 bg-blue-500 rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                    >
                        Post Property
                    </button>
                </div>
